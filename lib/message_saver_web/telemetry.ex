defmodule MessageSaverWeb.Telemetry do
  use Supervisor
  ...
  def metrics do
    [
      ...
      summary("message_saver.repo.query.total_time", unit: {:native, :millisecond}),
      summary("message_saver.repo.query.decode_time", unit: {:native, :millisecond}),
      summary("message_saver.repo.query.query_time", unit: {:native, :millisecond}),
      summary("message_saver.repo.query.queue_time", unit: {:native, :millisecond}),
      summary("message_saver.repo.query.idle_time", unit: {:native, :millisecond}),
